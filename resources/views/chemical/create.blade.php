							...
							<form action="{{ route('chemical.store') }}" method="post" enctype="multipart/form-data">
						   		...
						   		<div class="col-md-4">
								   	<div class="form-group">
								   		...
								   		<input type="text" name="name" class="form-control" placeholder="Chemical Name">
								   	</div>
								</div>
								<div class="col-md-4">
								   	<div class="form-group">
								   		<label for="use_for">Use For</label>
								   		<input type="text" name="use_for" class="form-control" placeholder="Use For">
								   	</div>
								</div>
								<div class="col-md-4">
								   	<div class="form-group">
								   		<label for="scientific">Scientific Name</label>
								   		<input type="text" name="scientific" class="form-control" placeholder="Scientific Name">
								   	</div>
								</div>
								<div class="col-md-12">
								   	<div class="form-group">
