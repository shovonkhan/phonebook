            		...
            		<div class="box box-primary">
		                ...
		                <!-- form start -->
	  					...
	  					<div class="box-body">
							...
							<form action="{{URL::to('insert_yarn_receive') }}" method="post" accept-charset="utf-8">
							{{ csrf_field() }}
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="bill" placeholder="Bill Number">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="form-group">
										<label>Challan Number</label>
										<input type="text" class="form-control" name="challan" placeholder="Challan Number">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="form-group">
								...
								<div class="col-lg-4">
									<div class="form-group">
										<label>Maenufature Name</label>
										<select class="form-control select2" name="manufacture_id">
											<option>Select Manufature</option>
									...
									<div class="form-group">
										<table class="table table-bordered">
											...
											<tbody>
												<tr>
													<td width="25%">
														<select name="productname[]" class="select2 form-control productname" id="productname">
