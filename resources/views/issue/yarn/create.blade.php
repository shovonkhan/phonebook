  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Yarn Issue Create</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Yarn Issue Create</h3>
        ...
        <div class="box-body">
          ...
          @endif
              <!-- /.box-header -->
              <div class="box-body">
          <form action="{{ route('yarnIssueStore')}}" method="post" accept-charset="utf-8">
            {{ csrf_field() }}
            <div class="row">
              <div class="col-lg-2">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="bill" readonly="readonly" placeholder="Bill Number" value="W-<?php echo(rand(100000,999999)); ?>">
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <select class="form-control" name="department">
                    ...
                    <option value="Worping">Worping</option>
                    <option value="Weiving">Weiving</option>
                      ...
                      <tr>
                        <td>
                          <select name="productname[]" class="form-control productname" id="productname">
                            ...
                            @foreach($yarns as $product)
                            <option value="{{ $product->id }}">{{ $product->yarn_name }}</option>
                            @endforeach
                          </select>

                        </td>
                        <td>
                          <select class="form-control manufacture" name="manufacture[]">
                            @foreach($manufacture as $manufac)
                            <option value="{{ $manufac->manufacture_name }}">{{ $manufac->manufacture_name }}</option>
                            @endforeach
                          </select>
                        </td>
...
<script type="text/javascript">
    ...
    function addRow()
    {
      var tr = '<tr>'+
            '<td>'+
              '<select name="productname[]" class="form-control select2 productname" id="productname">'+
            ...
            '</td>'+
            '<td><select class="form-control manufacture" name="manufacture[]">'+
                    '@foreach($manufacture as $manufac)'+
                            '<option value="{{ $manufac->manufacture_name }}">{{ $manufac->manufacture_name }}</option>'+
                      '@endforeach'+
                  '</select></td>'+
