        	...
        	<div class="col-md-12">
          		<div class="box box-info">
              		<div class="box box-primary">
			            ...
			            <div class="box-body">
				            <!-- form start -->
							<form action="{{ route('fabric_stock.store') }}" method="post">
							   {{ csrf_field() }}
							   	<table class="table table-bordered">
									...
									<tbody>
										<tr>
											<td>
												<input type="text" name="date" class="form-control" placeholder="Date" id="datepicker" autocomplete="off">
											</td>
											<td width="25%">
											   	<select name="fabric_code" class="form-control productname" id="productname">
											   		...
											   		<option value="{{ $fabric->id }}">{{ $fabric->fabric_code }}</option>
											   		@endforeach
											   	</select>
											</td>
											<td><input type="text" name="receive" class="form-control receive"></td>
											<td><input type="text" name="opening_stock" class="form-control opening_stock"></td>
											<td>
											   	<select name="grade" class="form-control">
											   		<option value="A">A</option>
											   		<option value="B">B</option>
											   		<option value="C">C</option>
											   		<option value="Cut Pices">Cut Pices</option>
											   		<option value="Sort Pices">Sort Pices</option>
											   	</select>
											   	</td>
											<td><input type="text" name="total_stock"  readonly="readonly" class="form-control total_stock" style="background:#fff; cursor: default;"></td>
										</tr>
									</tbody>
								</table>
								<div class="col-md-12">
